...
class Timecore {
     ...
     **************************************************************************************************/
    void begin( bool use_ticker = false );
     ...
     *    Class         : Timecore
     *    Description   : Converts UTC time to local time
     *    Input         : UTC time
     *    Output        : time_t
     *    Remarks       : Returns the local time according to the settings
     **************************************************************************************************/
    time_t ConvertToLocalTime( time_t now );
   ...
   **************************************************************************************************/  
    static void RTC_Tick( Timecore* pThis ); /* Needs to be called once a second */
